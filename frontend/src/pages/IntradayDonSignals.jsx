              ...
              <tbody>
                {groupedSignals[selectedSymbol].map((signal, index) => (
                  ...
                  >
                    ...
                    <td className="border border-gray-600 px-4 py-2">
                      {numeral(signal.buy_signal).format()}
                    </td>
                    <td className="border border-gray-600 px-4 py-2">
                      {numeral(signal.sell_signal).format()}
                    </td>
                  </tr>
                ))}
              </tbody>
...
export default IntradayDonSignals;
